...
pub struct StreamDebugView {
    ...
    pub advertised_target_profile: String,
    pub active_layer: u8,
    pub capture_fps: f32,
    pub encoded_fps: f32,
    pub decoded_fps: f32,
    ...
    pub queue_depth_capture: u64,
    pub queue_depth_encode: u64,
    pub queue_depth_packetize: u64,
    pub current_rendered_resolution: String,
    pub video_datagrams_per_sec: u64,
    pub video_tx_datagrams_per_sec: u64,
    pub video_tx_bytes_per_sec: u64,
    pub video_tx_blocked_per_sec: u64,
...
pub struct UiModel {
    ...
    pub last_typing_sent_at: HashMap<String, std::time::Instant>,
